...
/**
 * The qdev.unb.utils.GamePanel class represents the drawable area on the screen.
...
public class GamePanel extends JPanel implements MouseListener, MouseMotionListener
{
    ...
    private Game enclosingGame;  	// A reference back to the qdev.unb.Game object that created 'this' object.
    ...
    /**
     * Creates the qdev.unb.utils.GamePanel object (which is really just
     * a JPanel object with a little extra functionality.)
     * The qdev.unb.utils.GamePanel represents a drawable area on the screen.
     * It has a paint method, and we can listen for events on this
     * object if we want.
     * 
     * @param enclosingGame the qdev.unb.Game object that is creating this panel
     */
    public GamePanel (Game enclosingGame)
    {
        // Keep track of the qdev.unb.Game object that created this panel.
     ...
     * our panel call back to the qdev.unb.Game object, and let the qdev.unb.Game object draw
     * everything.
     * 
